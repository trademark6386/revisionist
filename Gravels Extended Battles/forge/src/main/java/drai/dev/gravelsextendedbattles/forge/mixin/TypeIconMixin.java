...
import static drai.dev.gravelsextendedbattles.forge.GravelsExtendedBattlesForge.ICON_MIXIN_INIT;
...
public abstract class TypeIconMixin implements GravelmonTypeIconMixin {
    ...
    @Shadow
    @Final
    private static Identifier smallTypesResource;

    @Mutable
    @Shadow
    @Final
    private static Identifier typesResource;
    @Shadow
    @Final
