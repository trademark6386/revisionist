...
import static drai.dev.gravelsextendedbattles.forge.GravelsExtendedBattlesForge.scaleNeedsARefresh;
                ...
                if(directory instanceof String){
                    ...
                    resourceManager.findResources((String) directory, (identifier)-> identifier.toString().endsWith(".json")).forEach(((identifier, resource) ->
                    {
                            try {
                                ...
                                if(modelVariationSet.getName().getPath().equalsIgnoreCase("goodra")){
